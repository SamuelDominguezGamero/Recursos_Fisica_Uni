...
### Ley de Gauss, distribuciones de carga
...
### Campo magnético
#### Parte 1: efecto del campo magnético sobre las corrientes eléctricas (cap. 27 del libro de Sears-Zemansky). Ley de Lorentz. Efecto del campo magnético sobre conductores. Torque de una espira.
...
#### Parte 2: origen del campo magnético (corrientes eléctricas). Ley de Biot-Savart, y su integración sobre diferentes geometrías. Ley de Ampère (casos de simetría)
* [(Vídeo) Ley de Biot y Savart](https://youtu.be/WSDVvHvIEk4?si=QKmqfscLO2l2lQ8i)
* [(Vídeo) Relación entre corriente y campo magnético. Biot y Savart. Ampère](https://youtu.be/icjJRpoDqOc?si=yV_4tRymhR3j4ObF)
